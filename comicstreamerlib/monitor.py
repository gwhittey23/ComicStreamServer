...
class Monitor():
    ...
    def addComicFromMetadata(self, md ):
        ...
        if md.alternateSeries is not None:
                for alt in list(set(md.alternateSeries.split(","))):
                    alternateseries = self.fetchObjByName(self.alternateseries_dict, alt.strip())
    ...
    def buildChildSets(self, md):       
        ...
        if md.alternateSeries is not None:
            for n in list(set(md.alternateSeries.split(","))):
                self.alternateseries_names.add(n.strip())
    ...
    def saveChildInfoToDB(self, md_list):
        ...
        for md in md_list:
            ...
            if md.alternateSeries is not None:
                for n in list(set(md.alternateSeries.split(","))):
                    alternateseries_names.add(n.strip())
        ...
        addNamedObjects(AlternateSeries, alternateseries_names)
    ...
    def createChildDicts(self):
        ...
        alternateseries_objs = self.session.query(AlternateSeries).all()
        ...
        self.alternateseries_dict = dict()
        ...
        buildDict(alternateseries_objs, self.alternateseries_dict)
